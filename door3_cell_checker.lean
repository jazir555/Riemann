...
/-! ### R73 proxy cell (mid-bottom).

R73 = x [4,13/2] x y [1/100,1/5], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.095`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R73 block
(lines 814-838), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R73 radius upper bound through the generalized checker rule. -/
theorem R73_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2) ≤ (1.26 : ℝ) :=
  cert_sqrt_upper_check

/-- R73 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R73_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R73 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R73_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R73_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
/-- R73 proxy center bound transported through the norm bridge. -/
theorem R73_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R73_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
#print axioms R73_radius_upper_checker
#print axioms R73_tail_mono
#print axioms R73_proxy_center
#print axioms R73_proxy_center_norm


/-! ### R83 proxy cell (outer-bottom).

R83 = x [6,17/2] x y [1/100,1/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.095`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R83 block
(lines 918-942), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R83 radius upper bound through the generalized checker rule. -/
theorem R83_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2) ≤ (1.26 : ℝ) :=
  cert_sqrt_upper_check

/-- R83 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R83_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R83 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R83_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R83_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
/-- R83 proxy center bound transported through the norm bridge. -/
theorem R83_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R83_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
#print axioms R83_radius_upper_checker
#print axioms R83_tail_mono
#print axioms R83_proxy_center
#print axioms R83_proxy_center_norm


/-! ### R93 proxy cell (outer-bottom).

R93 = x [15/2,10] x y [1/100,1/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.095`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R93 block
(lines 1022-1046), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R93 radius upper bound through the generalized checker rule. -/
theorem R93_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2) ≤ (1.26 : ℝ) :=
  cert_sqrt_upper_check

/-- R93 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R93_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R93 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R93_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R93_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
/-- R93 proxy center bound transported through the norm bridge. -/
theorem R93_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R93_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
#print axioms R93_radius_upper_checker
#print axioms R93_tail_mono
#print axioms R93_proxy_center
#print axioms R93_proxy_center_norm


/-! ### R03 proxy cell (outer-bottom).

R03 = x [-10,-15/2] x y [1/100,1/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.095`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R03 block
(lines 86-110), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R03 radius upper bound through the generalized checker rule. -/
theorem R03_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2) ≤ (1.26 : ℝ) :=
  cert_sqrt_upper_check

/-- R03 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R03_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R03 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R03_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R03_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
/-- R03 proxy center bound transported through the norm bridge. -/
theorem R03_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R03_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.095 : ℝ) ^ 2)
...
#print axioms R03_radius_upper_checker
#print axioms R03_tail_mono
#print axioms R03_proxy_center
#print axioms R03_proxy_center_norm

/-! ### R02 proxy cell (outer, y-row 2).

R02 = x [-10,-15/2] x y [1/10,3/10], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R02 block
(lines 60-84), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R02 radius upper bound through the generalized checker rule. -/
theorem R02_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R02 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R02_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R02 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R02_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R02_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (0.002 : ℝ) + 0.05 * 1.26 := by linarith
  have h2 : ((0.002 : ℝ) + 0.05 * 1.26) ≤ ((certHead : ℚ) : ℝ) := by
    have hle : ((0.002 : ℝ) + 0.05 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle cert_sample_center_proxy
...
/-- R02 proxy center bound transported through the norm bridge. -/
theorem R02_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R02_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h4 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (((1 : ℚ)) : ℝ) := by
    have hle : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
        ≤ (0.002 : ℝ) + 0.05 * 1.26 := by linarith
    have hlt : ((0.002 : ℝ) + 0.05 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle hlt
  exact le_trans h4 cert_norm_cast

#print axioms R02_radius_upper_checker
#print axioms R02_tail_mono
#print axioms R02_proxy_center
#print axioms R02_proxy_center_norm

/-! ### R12 proxy cell (outer, y-row 2).

R12 = x [-8,-11/2] x y [1/10,3/10], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R12 block
(lines 164-188), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R12 radius upper bound through the generalized checker rule. -/
theorem R12_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R12 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R12_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R12 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R12_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R12_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R12 proxy center bound transported through the norm bridge. -/
theorem R12_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R12_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R12_radius_upper_checker
#print axioms R12_tail_mono
#print axioms R12_proxy_center
#print axioms R12_proxy_center_norm

/-! ### R22 proxy cell (mid, y-row 2).

R22 = x [-6,-7/2] x y [1/10,3/10], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R22 block
(lines 268-292), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R22 radius upper bound through the generalized checker rule. -/
theorem R22_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R22 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R22_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R22 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R22_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R22_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (0.05 : ℝ) + 0.07 * 1.26 := by linarith
  have h2 : ((0.05 : ℝ) + 0.07 * 1.26) ≤ ((certHead : ℚ) : ℝ) := by
    have hle : ((0.05 : ℝ) + 0.07 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle cert_sample_center_proxy
...
/-- R22 proxy center bound transported through the norm bridge. -/
theorem R22_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R22_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h4 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (((1 : ℚ)) : ℝ) := by
    have hle : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
        ≤ (0.05 : ℝ) + 0.07 * 1.26 := by linarith
    have hlt : ((0.05 : ℝ) + 0.07 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle hlt
  exact le_trans h4 cert_norm_cast

#print axioms R22_radius_upper_checker
#print axioms R22_tail_mono
#print axioms R22_proxy_center
#print axioms R22_proxy_center_norm

/-! ### R32 proxy cell (mid, y-row 2).

R32 = x [-4,-3/2] x y [1/10,3/10], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R32 block
(lines 372-396), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R32 radius upper bound through the generalized checker rule. -/
theorem R32_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R32 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R32_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R32 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R32_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R32_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R32 proxy center bound transported through the norm bridge. -/
theorem R32_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R32_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R32_radius_upper_checker
#print axioms R32_tail_mono
#print axioms R32_proxy_center
#print axioms R32_proxy_center_norm

/-! ### R42 proxy cell (inner, y-row 2).

R42 = x [-2,1/2] x y [1/10,3/10], tier inner `(eps,M) = (0.15,0.06)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R42 block
(lines 476-500), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R42 radius upper bound through the generalized checker rule. -/
theorem R42_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R42 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R42_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R42 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R42_proxy_center :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R42_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.06 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (0.15 : ℝ) + 0.06 * 1.26 := by linarith
  have h2 : ((0.15 : ℝ) + 0.06 * 1.26) ≤ ((certHead : ℚ) : ℝ) := by
    have hle : ((0.15 : ℝ) + 0.06 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle cert_sample_center_proxy
...
/-- R42 proxy center bound transported through the norm bridge. -/
theorem R42_proxy_center_norm :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R42_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.06 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h4 : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ (((1 : ℚ)) : ℝ) := by
    have hle : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
        ≤ (0.15 : ℝ) + 0.06 * 1.26 := by linarith
    have hlt : ((0.15 : ℝ) + 0.06 * 1.26) ≤ (((1 : ℚ)) : ℝ) := by norm_num
    exact le_trans hle hlt
  exact le_trans h4 cert_norm_cast

#print axioms R42_radius_upper_checker
#print axioms R42_tail_mono
#print axioms R42_proxy_center
#print axioms R42_proxy_center_norm

/-! ### R52 proxy cell (inner, y-row 2).

R52 = x [0,5/2] x y [1/10,3/10], tier inner `(eps,M) = (0.15,0.06)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R52 block
(lines 580-604), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R52 radius upper bound through the generalized checker rule. -/
theorem R52_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R52 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R52_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R52 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R52_proxy_center :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R52_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.06 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R52 proxy center bound transported through the norm bridge. -/
theorem R52_proxy_center_norm :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R52_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R52_radius_upper_checker
#print axioms R52_tail_mono
#print axioms R52_proxy_center
#print axioms R52_proxy_center_norm

/-! ### R62 proxy cell (mid, y-row 2).

R62 = x [2,9/2] x y [1/10,3/10], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R62 block
(lines 684-708), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R62 radius upper bound through the generalized checker rule. -/
theorem R62_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R62 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R62_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R62 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R62_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R62_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R62 proxy center bound transported through the norm bridge. -/
theorem R62_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R62_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R62_radius_upper_checker
#print axioms R62_tail_mono
#print axioms R62_proxy_center
#print axioms R62_proxy_center_norm

/-! ### R72 proxy cell (mid, y-row 2).

R72 = x [4,13/2] x y [1/10,3/10], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R72 block
(lines 788-812), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R72 radius upper bound through the generalized checker rule. -/
theorem R72_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R72 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R72_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R72 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R72_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R72_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R72 proxy center bound transported through the norm bridge. -/
theorem R72_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R72_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R72_radius_upper_checker
#print axioms R72_tail_mono
#print axioms R72_proxy_center
#print axioms R72_proxy_center_norm

/-! ### R82 proxy cell (outer, y-row 2).

R82 = x [6,17/2] x y [1/10,3/10], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R82 block
(lines 892-917), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R82 radius upper bound through the generalized checker rule. -/
theorem R82_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R82 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R82_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R82 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R82_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R82_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R82 proxy center bound transported through the norm bridge. -/
theorem R82_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R82_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R82_radius_upper_checker
#print axioms R82_tail_mono
#print axioms R82_proxy_center
#print axioms R82_proxy_center_norm

/-! ### R92 proxy cell (outer, y-row 2).

R92 = x [15/2,10] x y [1/10,3/10], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R92 block
(lines 996-1021), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R92 radius upper bound through the generalized checker rule. -/
theorem R92_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R92 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R92_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R92 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R92_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R92_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R92 proxy center bound transported through the norm bridge. -/
theorem R92_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R92_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R92_radius_upper_checker
#print axioms R92_tail_mono
#print axioms R92_proxy_center
#print axioms R92_proxy_center_norm

/-! ### R01 proxy cell (outer, y-row 1).

R01 = x [-10,-15/2] x y [1/5,2/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R01 block
(lines 34-58), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R01 radius upper bound through the generalized checker rule. -/
theorem R01_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R01 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R01_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R01 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R01_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R01_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R01 proxy center bound transported through the norm bridge. -/
theorem R01_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R01_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R01_radius_upper_checker
#print axioms R01_tail_mono
#print axioms R01_proxy_center
#print axioms R01_proxy_center_norm

/-! ### R11 proxy cell (outer, y-row 1).

R11 = x [-8,-11/2] x y [1/5,2/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R11 block
(lines 138-162), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R11 radius upper bound through the generalized checker rule. -/
theorem R11_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R11 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R11_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R11 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R11_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R11_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R11 proxy center bound transported through the norm bridge. -/
theorem R11_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R11_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R11_radius_upper_checker
#print axioms R11_tail_mono
#print axioms R11_proxy_center
#print axioms R11_proxy_center_norm

/-! ### R21 proxy cell (mid, y-row 1).

R21 = x [-6,-7/2] x y [1/5,2/5], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R21 block
(lines 242-266), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R21 radius upper bound through the generalized checker rule. -/
theorem R21_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R21 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R21_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R21 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R21_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R21_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R21 proxy center bound transported through the norm bridge. -/
theorem R21_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R21_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R21_radius_upper_checker
#print axioms R21_tail_mono
#print axioms R21_proxy_center
#print axioms R21_proxy_center_norm

/-! ### R31 proxy cell (mid, y-row 1).

R31 = x [-4,-3/2] x y [1/5,2/5], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R31 block
(lines 346-370), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R31 radius upper bound through the generalized checker rule. -/
theorem R31_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R31 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R31_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R31 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R31_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R31_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R31 proxy center bound transported through the norm bridge. -/
theorem R31_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R31_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R31_radius_upper_checker
#print axioms R31_tail_mono
#print axioms R31_proxy_center
#print axioms R31_proxy_center_norm

/-! ### R41 proxy cell (inner, y-row 1).

R41 = x [-2,1/2] x y [1/5,2/5], tier inner `(eps,M) = (0.15,0.06)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R41 block
(lines 450-474), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R41 radius upper bound through the generalized checker rule. -/
theorem R41_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R41 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R41_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R41 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R41_proxy_center :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R41_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.06 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R41 proxy center bound transported through the norm bridge. -/
theorem R41_proxy_center_norm :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R41_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R41_radius_upper_checker
#print axioms R41_tail_mono
#print axioms R41_proxy_center
#print axioms R41_proxy_center_norm

/-! ### R51 proxy cell (inner, y-row 1).

R51 = x [0,5/2] x y [1/5,2/5], tier inner `(eps,M) = (0.15,0.06)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R51 block
(lines 554-578), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R51 radius upper bound through the generalized checker rule. -/
theorem R51_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R51 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R51_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R51 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R51_proxy_center :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R51_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.06 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R51 proxy center bound transported through the norm bridge. -/
theorem R51_proxy_center_norm :
    (0.15 : ℝ) + 0.06 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R51_radius_upper_checker
  have hM : (0.06 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R51_radius_upper_checker
#print axioms R51_tail_mono
#print axioms R51_proxy_center
#print axioms R51_proxy_center_norm


/-! ### R61 proxy cell (mid, y-row 1).

R61 = x [2,9/2] x y [1/5,2/5], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R61 block
(lines 658-683), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R61 radius upper bound through the generalized checker rule. -/
theorem R61_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R61 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R61_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R61 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R61_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R61_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R61 proxy center bound transported through the norm bridge. -/
theorem R61_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R61_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R61_radius_upper_checker
#print axioms R61_tail_mono
#print axioms R61_proxy_center
#print axioms R61_proxy_center_norm


/-! ### R71 proxy cell (mid, y-row 1).

R71 = x [4,13/2] x y [1/5,2/5], tier mid `(eps,M) = (0.05,0.07)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R71 block
(lines 762-787), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R71 radius upper bound through the generalized checker rule. -/
theorem R71_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R71 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R71_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R71 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R71_proxy_center :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R71_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.07 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R71 proxy center bound transported through the norm bridge. -/
theorem R71_proxy_center_norm :
    (0.05 : ℝ) + 0.07 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R71_radius_upper_checker
  have hM : (0.07 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R71_radius_upper_checker
#print axioms R71_tail_mono
#print axioms R71_proxy_center
#print axioms R71_proxy_center_norm


/-! ### R81 proxy cell (outer, y-row 1).

R81 = x [6,17/2] x y [1/5,2/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R81 block
(lines 866-891), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R81 radius upper bound through the generalized checker rule. -/
theorem R81_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R81 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R81_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R81 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R81_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R81_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R81 proxy center bound transported through the norm bridge. -/
theorem R81_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R81_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R81_radius_upper_checker
#print axioms R81_tail_mono
#print axioms R81_proxy_center
#print axioms R81_proxy_center_norm


/-! ### R91 proxy cell (outer, y-row 1).

R91 = x [15/2,10] x y [1/5,2/5], tier outer `(eps,M) = (0.002,0.05)`,
`dx = 1.25`, `dy = 0.1`, cap `1.26`. Copied from generator
`C:\Users\mmeadow\AppData\Local\Temp\kilo\door3_certs40.lean` R91 block
(lines 970-995), renamed to checker pattern
`R00_radius_upper_checker/R00_tail_mono/R00_proxy_center/R00_proxy_center_norm`.
All steps `by norm_num` or `linarith`, numerals <=6 digits. -/

/-- R91 radius upper bound through the generalized checker rule. -/
theorem R91_radius_upper_checker :
    Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2) ≤ (1.26 : ℝ) := by
  apply real_sqrt_upper (by norm_num)
  norm_num

/-- R91 tail step reusing the proved majorant `zeta2_partial_mono`. -/
theorem R91_tail_mono :
    (∑ k ∈ Finset.range 1, (1 : ℚ) / ((k + 1 : ℚ) ^ 2)) ≤ certHead := by
  have h := zeta2_partial_mono (n := 1) (m := 5) (by norm_num)
  rw [certHead_sum_eq] at h
  exact h

/-- R91 proxy center bound (`center_bound` shape at the 1.26 radius cap). -/
theorem R91_proxy_center :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ((certHead : ℚ) : ℝ) := by
  have hRad := R91_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ 0.05 * 1.26 :=
    mul_le_mul_of_nonneg_left hRad (by norm_num)
  have h1 : (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
/-- R91 proxy center bound transported through the norm bridge. -/
theorem R91_proxy_center_norm :
    (0.002 : ℝ) + 0.05 * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
      ≤ ‖(((1 : ℚ)) : ℝ) + (((7 / 10 : ℚ)) : ℝ) * Complex.I‖ := by
  have hRad := R91_radius_upper_checker
  have hM : (0.05 : ℝ) * Real.sqrt ((1.25 : ℝ) ^ 2 + (0.1 : ℝ) ^ 2)
...
#print axioms R91_radius_upper_checker
#print axioms R91_tail_mono
#print axioms R91_proxy_center
#print axioms R91_proxy_center_norm

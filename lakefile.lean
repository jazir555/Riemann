    ...
    #[`ZeroFreeRegionHadamard, `ZeroFreeRegionProof, `riemann_hypothesis, `HadamardBridge, `Zeta23,
      `KadiriZeroFree, `KadiriOrderInfra, `KadiriZerosInfra2, `KadiriHScratch,
       ...
       `ktest, `ScratchCheck, `JTest, `XiStub, `TestScratch, `TestZeta0,
         ...
         `door3_cell_checker, `door3_deriv_certs, `door3_gamma_product, `door3_gamma_cutoff, `door3_zeta_cutoff, `door3_tail_eta_upper, `door3_boundary_real, `door3_boundary_endpoints, `door3_top_edge, `door3_imag_axis_strip, `door3_height11_bridge, `door3_float_bridge_audit, `door3_real_radius_bridge, `door3_zeta_pair_tightening, `door3_grid_boundary_counterexample, `door3_trusted_statement_audit, `door3_closed_cover, `door3_zeta_cert_range_audit, `door3_numeric_targets, `door3_rational_certificates, `door3_s4_imag, `door3_center_bounds, `door3_rational_grid_cover]

...
`door3_premise_zeta, `door3_dp_headA, `door3_tier_direct, `door3_dp_headB, `door3_zlowN, `door3_gamma_low, `door3_dp_headC1, `door3_subdiv_plan, `door3_zeta_N64, `door3_gamma_disc, `door3_R05_close, `door3_deriv_up, `door3_gamma_real_low, `door3_gamma_feed, `door3_digamma, `door3_eta_prime, `door3_stirling_rem, `door3_psi_slope, `door3_complex_wendel]
